     ...
     <div class="container">
         ...
         <div class="clearfix" style="margin-top: 20px;margin-bottom: 20px;">
            ...
            <section class="row clearfix" style="margin-bottom: 20px;">
             ...
             <section class="row">
                ...
                <input class="col-md-2" type="text"  value="${oil_2.outletFlow}" id="4">
        ...
        <div class="border border-primary "style="margin-bottom: 20px;">
            ...
            <section class="row clearfix" style="margin-bottom: 20px;">
                ...
                <input class="col-md-2" type="text"  value="${oil_2.standpipePressurelog}"id="5">
                <center class="col-md-4">节流后压力（测量）</center>
                <input class="col-md-2" type="text"  value="不知道对应哪个字段" id="6">
             </section>
             <section class="row clearfix" style="margin-bottom: 20px;">
            ...
            <section class="row clearfix" style="margin-bottom: 20px;">
                ...
                <input class="col-md-2" type="text" id="10" value="${oil_2.wellMouthAdjustment}">
        ...
        <div class="border border-primary ">
            ...
            <section class="row">
                ...
                <input class="col-md-2" id="11" type="number"  value="${oil_2.inletDensitylog}">
                <center class="col-md-4">出口密度（测量）</center>
                <input class="col-md-2" type="text"   id="12"  value="${oil_2.outletDensitylog}">
            </section>
            </div>
        </div>
